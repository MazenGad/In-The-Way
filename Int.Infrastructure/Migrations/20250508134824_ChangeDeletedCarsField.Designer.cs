...
namespace Int.Infrastructure.Migrations
{
    ...
    [Migration("20250508134824_ChangeDeletedCarsField")]
    partial class ChangeDeletedCarsField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Int.Domain.Entities.CarPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Int.Domain.Entities.Chat.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Int.Domain.Entities.CarPhoto", b =>
                {
                    b.HasOne("Int.Domain.Entities.Car", "car")
                        .WithMany("CarPhotos")
                        .HasForeignKey("carId")
            ...
            modelBuilder.Entity("Int.Domain.Entities.Chat.Chat", b =>
                {
                    b.HasOne("Int.Domain.Entities.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Int.Domain.Entities.User", "Sender")
                        .WithMany()
